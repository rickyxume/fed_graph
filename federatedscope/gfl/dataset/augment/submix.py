...
def mix_graphs(dst_graph, dst_nodes, src_graph, src_nodes, num_labels,
    ...
    if new_edges.size(1) == 0:
        ...
        return Data(x=dst_graph.x, edge_index=dst_graph.edge_index, edge_attr=dst_graph.edge_attr, y=new_y,data_index=dst_graph.data_index)
    ...
    # new_graph = Data(x=new_x, edge_index=new_edges, edge_attr=graph.edge_attr, y=new_y,data_index=graph.data_index)
    # return new_graph
