...
from federatedscope.gfl.dataset.augment import utils
...
class DropEdge(object):
    ...
    def __call__(self, index):
        ...
        new_graph = Data(x=graph.x, edge_index=edge_index, edge_attr=graph.edge_attr, y=graph.y)
        return new_graph
...
class DropNode(object):
    ...
    def __call__(self, index):
        ...
        new_graph = Data(x=graph.x[node_mask], edge_index=edge_index, edge_attr=graph.edge_attr, y=graph.y)
        return new_graph
...
class ChangeAttr(object):
    ...
    def __call__(self, index):
        ...
        new_graph = Data(x=new_x, edge_index=graph.edge_index, edge_attr=graph.edge_attr, y=graph.y)
        return new_graph
